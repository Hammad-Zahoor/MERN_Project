  ...
  return (
    <>
      ...
      <div className='profile-body'>
        ...
        <img className='profile-pic' src={profile.length !== 0 ? profile.image : 'No data available'}></img>
        ...
        <h3>{profile.length !== 0 ? profile.name : 'No data available'} - {profile.length !== 0 ? profile.role : 'No data available'}</h3>
        <h3>{profile.length !== 0 ? profile.education : 'No data available'} - {profile.length !== 0 ? profile.major : 'No data available'}</h3>
          ...
          <div key={index}>
            <div className='profile-post'>
              ...
              <div className='post-likes'>
                <h4>{post.length !== 0 ? post.likes_count : 'No data available'}</h4>
                <button>Like</button>
                <h4>Comment</h4>
